...
#define SHUT2_Pin GPIO_PIN_1
#define SHUT2_GPIO_Port GPIOH
...
#define INTOF2_Pin GPIO_PIN_10
#define INTOF2_GPIO_Port GPIOC
#define INTOF2_EXTI_IRQn EXTI15_10_IRQn
